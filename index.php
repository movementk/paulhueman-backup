...
<body class="main">
    ...
    <main id="content">
        ...
        <div id="campaign">
            <div class="container">
                <div class="campaign-item campaign-item-1">
                    <a href="#">
                        <img class="visible-lg" src="/assets/images/main/img_lookbook_lg.jpg" alt="">
                        <img class="visible-sm visible-md" src="/assets/images/main/img_lookbook_sm.jpg" alt="">
                        <img class="visible-xs" src="/assets/images/main/img_lookbook_xs.jpg" alt="">
                    </a>
                </div>
                <div class="campaign-item campaign-item-2">
                    <a href="#">
                        <img class="visible-lg" src="/assets/images/main/img_brandstory_lg.jpg" alt="">
                        <img class="visible-sm visible-md" src="/assets/images/main/img_brandstory_sm.jpg" alt="">
                        <img class="visible-xs" src="/assets/images/main/img_brandstory_xs.jpg" alt="">
                    </a>
                </div>
            ...
            <div class="container">
                <ul class="row product-list">
                    <li class="col-xs-6">
                        <a href="#">
                            <figure>
                                <img class="img-responsive" src="/assets/images/main/img_product_dummy.jpg">
                                <figcaption>PHS-1089D Col.5</figcaption>
                            </figure>
                        </a>
                    </li>
                    <li class="col-xs-6">
                ...
                <a class="btn-more" href="#">제품 더보기</a>
            </div>
        </div>
        <div id="diary">
            <div class="container">
                <div class="diary-list">
                    <div class="diary-item">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="figure">
                                    <p><img class="img-responsive" src="/assets/images/main/img_diary_dummy.jpg" alt=""></p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="details">
                                    <div>
                                        <small>DIARY</small>
                                        <h5>굿바이 미스터 블랙 제작지원합니다.</h5>
                                        <p>
                                            유행에 민감하지만 유행에 압도 당하지 않는<br>
                                            빠르게 변하는 유행에서 자신만의 스타일을 찾을 줄 아는 사람들의 패션 아이웨어<br>
                                            굿바이 미스터 블랙 제작지원합니다.
                                        </p>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-md-pull-6">
                                <div class="details">
                                    <div>
                                        <small>DIARY</small>
                                        <h5>2016 SILMO BANDO OPTICAL</h5>
                                        <p>
                                            유행에 민감하지만 유행에 압도 당하지 않는<br>
                                            빠르게 변하는 유행에서 자신만의 스타일을 찾을 줄 아는 사람들의 패션 아이웨어<br>
                                            굿바이 미스터 블랙 제작지원합니다.
    ...
    <script src="/assets/jquery.bxslider/jquery.bxslider.js"></script>
    <script>
        (function($) {
