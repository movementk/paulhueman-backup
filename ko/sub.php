    ...
    <main id="content">
        <div class="container">
            ...
            <div style="margin: 50px 0;">
                ...
                <ol class="step-list">
                    <li class="active">
                        <p><img src="/ko/assets/images/sub/step01_ico_active.png" alt="회원약관동의"></p>
                        <h3><i>STEP 01</i>회원약관동의</h3>
                    </li>
                    <li>
                        <p><img src="/ko/assets/images/sub/step02_ico.png" alt="회원약관동의"></p>
                        <h3><i>STEP 02</i>회원정보입력</h3>
                    </li>
                    <li>
                        <p><img src="/ko/assets/images/sub/step03_ico.png" alt="회원약관동의"></p>
                                            ...
                                            <li>
                                                <a href="#">
                                                    <figure>
                                                        <div class="glasses">
                                                            <p>
                                                                <img src="/ko/assets/images/sub/item_img01.jpg" class="img-responsive basic-img" alt="">
                                                            </p>
                                                            <p style="background-image: url(/ko/assets/images/sub/item_img_hover.jpg)">
                                                            </p>
                                                        </div>
                                                        <figcaption>
                                                            <p>PHS - 1089D Col.5</p>
                                            ...
                                            <li>
                                                <a href="#">
                                                    <figure>
                                                        <div class="glasses">
                                                            <p>
                                                                <img src="/ko/assets/images/sub/item_img02.jpg" class="img-responsive basic-img" alt="">
                                                            </p>
                                                            <p style="background-image: url(/ko/assets/images/sub/item_img_hover.jpg)">
                                                            </p>
                                                        </div>
                                            ...
                                            <li>
                                                <a href="#">
                                                    <figure>
                                                        <div class="glasses">
                                                            <p>
                                                                <img src="/ko/assets/images/sub/item_img03.jpg" class="img-responsive basic-img" alt="">
                                                            </p>
                                                            <p style="background-image: url(/ko/assets/images/sub/item_img_hover.jpg)">
                                                            </p>
                                                        </div>
                                            ...
                                            <li>
                                                <a href="#">
                                                    <figure>
                                                        <div class="glasses">
                                                            <p>
                                                                <img src="/ko/assets/images/sub/item_img04.jpg" class="img-responsive basic-img" alt="">
                                                            </p>
                                                            <p style="background-image: url(/ko/assets/images/sub/item_img_hover.jpg)">
                                                            </p>
                                                        </div>
                                            ...
                                            <li>
                                                <a href="#">
                                                    <figure>
                                                        <div class="glasses">
                                                            <p>
                                                                <img src="/ko/assets/images/sub/item_img05.jpg" class="img-responsive basic-img" alt="">
                                                            </p>
                                                            <p style="background-image: url(/ko/assets/images/sub/item_img_hover.jpg)">
                                                            </p>
                                                        </div>
                                            ...
                                            <li>
                                                <a href="#">
                                                    <figure>
                                                        <div class="glasses">
                                                            <p>
                                                                <img src="/ko/assets/images/sub/item_img06.jpg" class="img-responsive basic-img" alt="">
                                                            </p>
                                                            <p style="background-image: url(/ko/assets/images/sub/item_img_hover.jpg)">
                                                            </p>
                                                        </div>
                                            ...
                                            <li>
                                                <a href="#">
                                                    <figure>
                                                        <div class="glasses">
                                                            <p>
                                                                <img src="/ko/assets/images/sub/item_img07.jpg" class="img-responsive basic-img" alt="">
                                                            </p>
                                                            <p style="background-image: url(/ko/assets/images/sub/item_img_hover.jpg)">
                                                            </p>
                                                        </div>
