...
<body class="sub campaign">
    ...
    <main id="content" class="celeb-list">
        <div class="container">
            <!-- page-path -->
            <div class="page-path">
                <ol class="breadcrumb">
                    ...
                    <div class="col-xs-12 col-lg-2">
                        <div class="lnb">
                            ...
                            <ul>
                                ...
                                <li class="active"><a href="#">CELEB</a></li>
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-6 col-md-4">
                                    <div class="glasses-item">
                                        <a href="/ko/campaign/celeb_view.php">
                                            <figure>
                                                <img src="/ko/assets/images/campaign/star_img01.jpg" class="img-responsive" alt="">
                                                <figcaption>
                                                    민효린 스타일 폴휴먼 하금테<br>
                                                    선글라스_PHS-1070A
                                                </figcaption>
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-4">
                                    <div class="glasses-item">
                                        <a href="/ko/campaign/celeb_view.php">
                                            <figure>
                                                <img src="/ko/assets/images/campaign/star_img02.jpg" class="img-responsive" alt="">
                                                <figcaption>
                                                    살림하는 남자들 김승우 폴휴먼<br>
                                                    안경테 고급앤틱 눈길 끌어!
                                                </figcaption>
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-4">
                                    <div class="glasses-item">
                                        <a href="/ko/campaign/celeb_view.php">
                                            <figure>
                                                <img src="/ko/assets/images/campaign/star_img03.jpg" class="img-responsive" alt="">
                                                <figcaption>
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-4">
                                    <div class="glasses-item">
                                        <a href="/ko/campaign/celeb_view.php">
                                            <figure>
                                                <img src="/ko/assets/images/campaign/star_img04.jpg" class="img-responsive" alt="">
                                                <figcaption>
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-4">
                                    <div class="glasses-item">
                                        <a href="/ko/campaign/celeb_view.php">
                                            <figure>
                                                <img src="/ko/assets/images/campaign/star_img05.jpg" class="img-responsive" alt="">
                                                <figcaption>
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-4 none-sm">
                                    <div class="glasses-item">
                                        <a href="/ko/campaign/celeb_view.php">
                                            <figure>
                                                <img src="/ko/assets/images/campaign/star_img06.jpg" class="img-responsive" alt="">
                                                <figcaption>
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-4 none-sm">
                                    <div class="glasses-item">
                                        <a href="/ko/campaign/celeb_view.php">
                                            <figure>
                                                <img src="/ko/assets/images/campaign/star_img07.jpg" class="img-responsive" alt="">
                                                <figcaption>
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-4 none-sm">
                                    <div class="glasses-item">
                                        <a href="/ko/campaign/celeb_view.php">
                                            <figure>
                                                <img src="/ko/assets/images/campaign/star_img08.jpg" class="img-responsive" alt="">
                                                <figcaption>
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-4 none-md">
                                    <div class="glasses-item">
                                        <a href="/ko/campaign/celeb_view.php">
                                            <figure>
                                                <img src="/ko/assets/images/campaign/star_img09.jpg" class="img-responsive" alt="">
                                                <figcaption>
