                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-lg-10">
                        ...
                        <figure class="details-img">
                            <img src="/ko/assets/images/campaign/star_view_img01.jpg" class="img-responsive" alt="상세이미지">
                            <figcaption>
                        ...
                        <div class="product-front">
                            <div class="row">
                                <div class="col-xs-12 col-md-9">
                                    <p class="product-img">
                                        <img src="/ko/assets/images/campaign/celeb_glasses01.jpg" class="img-responsive" alt="상품 측면이미지">
                                    </p>
                                </div>
                        ...
                        <div class="product-aspect">
                            ...
                            <p class="product-img visible-lg">
                                <img src="/ko/assets/images/campaign/celeb_glasses03.jpg" class="img-responsive" alt="상품 측면이미지">
                            </p>
